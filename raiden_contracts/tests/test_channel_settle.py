...
def test_settle_wrong_state_fail(
    ...
    with pytest.raises(TransactionFailed, match="settle: channel not closed"):
        call_settle(token_network, channel_identifier, A, vals_A, B, vals_B)
    ...
    with pytest.raises(TransactionFailed, match="settle: settlement timeout"):
        call_settle(token_network, channel_identifier, A, vals_A, B, vals_B)
...
def test_settle_wrong_balance_hash(
    ...
    with pytest.raises(TransactionFailed, match="settle: invalid data for participant 1"):
    ...
    with pytest.raises(TransactionFailed, match="settle: invalid data for participant 2"):
