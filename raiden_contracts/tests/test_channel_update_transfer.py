...
def test_update_call(
    ...
    with pytest.raises(TransactionFailed, match="update: balance hash is zero"):
        token_network.functions.updateNonClosingBalanceProof(
            channel_identifier,
            A,
            B,
    ...
    with pytest.raises(TransactionFailed, match="update: nonce is zero"):
        token_network.functions.updateNonClosingBalanceProof(
            channel_identifier,
            A,
            B,
    ...
    with pytest.raises(TransactionFailed, match="update: invalid non-closing sig"):
        token_network.functions.updateNonClosingBalanceProof(
            channel_identifier,
            A,
            B,
...
def test_update_nonexistent_fail(
    ...
    with pytest.raises(TransactionFailed, match="update: channel id mismatch"):
        token_network.functions.updateNonClosingBalanceProof(
            channel_identifier,
            A,
            B,
...
def test_update_notclosed_fail(
    ...
    with pytest.raises(TransactionFailed, match="update: channel not closed"):
        token_network.functions.updateNonClosingBalanceProof(
            channel_identifier,
            A,
            B,
...
def test_update_wrong_nonce_fail(
    ...
    with pytest.raises(TransactionFailed, match="nonce reused"):
        token_network.functions.updateNonClosingBalanceProof(
            channel_identifier,
            A,
            B,
...
def test_update_not_allowed_for_the_closing_address(
    ...
    with pytest.raises(TransactionFailed, match="update: invalid closing sig"):
        token_network.functions.updateNonClosingBalanceProof(
            channel_identifier,
            A,
            B,
